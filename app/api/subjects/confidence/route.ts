...
export async function GET(req: Request) {
  try {
    ...
    const distribution = await SubjectAnalyticsService.getConfidenceDistribution(Number.parseInt(subjectId))
    ...
    return NextResponse.json(
      {
        status: "error",
        message: "Error al obtener distribución de confianza",
